...
private:
  ...
  Token evalBitOp(const Token& lexpr, const Token& rexpr, OperatorType op) const;

  Token evalCompare(const Token& lexpr, const Token& rexpr) const;
  Token evalLogical(const Token& lexpr, const Token& rexpr, OperatorType op) const;
  ...
  Token evalBinaryToken(const Token& lexpr, OperatorType op, const Token& rexpr) const;
