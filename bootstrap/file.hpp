...
namespace file {
  ...
  String appendDir(const String& path, const String& dirName, const String& dirName2);
  ...
  String appendDir(const String& path, const String& dirName1, const String& dirName2,
