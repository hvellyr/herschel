...
typedef void (*extobj_display_func)(sexp ctx, void* obj, sexp out);
struct extobj_class {
...
#define sexp_extobj_isa_display_call(ctx, p, out)                   \
  ((p)->value.extobj.isa->display_func(ctx, (p)->value.extobj.obj, out))
